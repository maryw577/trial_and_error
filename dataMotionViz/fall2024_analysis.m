...
[fig, p_values, ci, threshold, dataALL{3}.xData, dataALL{3}.yData, x_cueAud, p_cueAud, sz_cueAud, dataALL{3}.std_gaussian, dataALL{3}.mdl] = normCDF_plotter(coherence_lvls, ...
    rightward_prob, chosen_threshold, left_coh_vals, right_coh_vals, ...
    coherence_frequency, compare_plot, save_name, vel_stair);
scatter(dataALL{3}.xData, dataALL{3}.yData, sz_cueAud, 'LineWidth', 2, 'MarkerEdgeColor', aud_color, 'HandleVisibility', 'off');
hold on
plot(x_cueAud, p_cueAud, 'LineWidth', 4, 'Color', aud_color, 'DisplayName', 'Auditory-Cued Congruent Audiovisual');
hold on
...
[fig, p_values, ci, threshold, dataALL{4}.xData, dataALL{4}.yData, x_cueVis, p_cueVis, sz_cueVis, dataALL{4}.std_gaussian, dataALL{4}.mdl] = normCDF_plotter(coherence_lvls, ...
    rightward_prob, chosen_threshold, left_coh_vals, right_coh_vals, ...
    coherence_frequency, compare_plot, save_name, vel_stair);
scatter(dataALL{4}.xData, dataALL{4}.yData, sz_cueVis, 'LineWidth', 2, 'MarkerEdgeColor', vis_color, 'HandleVisibility', 'off');
hold on
plot(x_cueVis, p_cueVis, 'LineWidth', 4, 'Color', vis_color, 'DisplayName', 'Visual-Cued Congruent Audiovisual');
...
coherence_lvls = unique(coherence_lvls, 'stable');
coherence_lvls = coherence_lvls';
[fig, p_values, ci, threshold, dataALL{5}.xData, dataALL{5}.yData, x_cueAV, p_cueAV, sz_cueAV, dataALL{5}.std_gaussian, dataALL{5}.mdl] = normCDF_plotter(coherence_lvls, ...
    rightward_prob, chosen_threshold, left_coh_vals, right_coh_vals, ...
    coherence_frequency, compare_plot, save_name, vel_stair);
scatter(dataALL{5}.xData, dataALL{5}.yData, sz_cueAud, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
hold on
plot(x_cueAV, p_cueAV, 'LineWidth', 4, 'Color', 'k', 'DisplayName', 'Audiovisual-Cued Congruent Audiovisual');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
...
scatter(xData_aud, yData_aud, sz_aud, 'LineWidth', 2, 'MarkerEdgeColor', '#d73027', 'HandleVisibility', 'off');
hold on;
plot(x_aud, p_aud, 'LineWidth', 3, 'Color', '#d73027', 'DisplayName', 'No Cue Auditory Only');

scatter(dataALL{3}.xData, dataALL{3}.yData, sz_cueAud, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x_cueAud, p_cueAud, 'LineWidth', 3, 'Color', 'k', 'DisplayName', 'Auditory-Cued Congruent Audiovisual');
...
hold on
plot(x, p, 'LineWidth', 3, 'Color', '#fee090', 'DisplayName', 'Auditory-Cued Incongruent Audiovisual');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
...
scatter(xData_vis, yData_vis, sz_vis, 'LineWidth', 2, 'MarkerEdgeColor', '#4575b4', 'HandleVisibility', 'off');
hold on;
plot(x_vis, p_vis, 'LineWidth', 3, 'Color', '#4575b4', 'DisplayName', 'No Cue Visual Only');

scatter(dataALL{4}.xData, dataALL{4}.yData, sz_cueVis, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
hold on;
plot(x_cueVis, p_cueVis, 'LineWidth', 3, 'Color', 'k', 'DisplayName', 'Visual-Cued Congruent Audiovisual');
...
hold on
plot(x, p, 'LineWidth', 3, 'Color', '#e0f3f8', 'DisplayName', 'Visual-Cued Incongruent Audiovisual');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
...
Std.AO = dataALL{1}.std_gaussian;
Std.VO = dataALL{2}.std_gaussian;
Std.AudCued_AV = dataALL{3}.std_gaussian;
Std.VisCued_AV = dataALL{4}.std_gaussian;
Std.AVCued_AV = dataALL{5}.std_gaussian;
Std.NoCued_AV = dataALL{6}.std_gaussian;
...
% Replace all the 0s to 3s for catch trials for splitapply
dataALL{6}.dataRaw(dataALL{6}.dataRaw(:, 1) == 0, 1) = 3;
dataALL{6}.dataRaw(dataALL{6}.dataRaw(:, 3) == 0, 1) = 3;

% Extract and separate AV congruent trials from AV incongruent trials
idx = dataALL{6}.dataRaw(:, 1) == dataALL{6}.dataRaw(:, 3);
congruent_trials = dataALL{6}.dataRaw(idx, :);
incongruent_trials = dataALL{6}.dataRaw(~idx, :);
...
coherence_lvls = unique(coherence_lvls, 'stable');
coherence_lvls = coherence_lvls';
[fig, p_values, ci, threshold, dataALL{6}.xData, dataALL{6}.yData, x_cueNo, p_cueNo, sz_cueNo, dataALL{6}.std_gaussian, dataALL{6}.mdl] = normCDF_plotter(coherence_lvls, ...
    rightward_prob, chosen_threshold, left_coh_vals, right_coh_vals, ...
    coherence_frequency, compare_plot, save_name, vel_stair);
scatter(dataALL{6}.xData, dataALL{6}.yData, sz_cueNo, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
hold on
plot(x_cueNo, p_cueNo, 'LineWidth', 4, 'Color', 'k', 'DisplayName', 'No Cue Congruent Audiovisual');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
...
%% Plot cue AV vs No Cue
figure; hold on;
scatter(dataALL{5}.xData, dataALL{5}.yData, sz_cueAV, 'LineWidth', 2, 'MarkerEdgeColor', both_color, 'HandleVisibility', 'off');
hold on
plot(x_cueAV, p_cueAV, 'LineWidth', 4, 'Color', both_color, 'DisplayName', 'Audiovisual-Cued Congruent Audiovisual');
hold on
scatter(dataALL{6}.xData, dataALL{6}.yData, sz_cueNo, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
hold on
plot(x_cueNo, p_cueNo, 'LineWidth', 4, 'Color', 'k', 'DisplayName', 'No Cue Congruent Audiovisual');
...
scatter(xData_vis, yData_vis, sz_vis, 'LineWidth', 2, 'MarkerEdgeColor', '#4575b4', 'HandleVisibility', 'off');
plot(x_vis, p_vis, 'LineWidth', 4, 'Color', '#4575b4', 'DisplayName', 'No Cue Visual Only');
scatter(dataALL{6}.xData, dataALL{6}.yData, sz_cueNo, 'LineWidth', 2, 'MarkerEdgeColor', both_color, 'HandleVisibility', 'off');
plot(x_cueNo, p_cueNo, 'LineWidth', 4, 'Color', both_color, 'DisplayName', 'No Cue Congruent Audiovisual');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
...
%% Example/ NO cue figure
figure; hold on;
scatter(dataALL{6}.xData, dataALL{6}.yData, sz_cueNo, 'LineWidth', 2, 'MarkerEdgeColor', 'k', 'HandleVisibility', 'off');
plot(x_cueNo, p_cueNo, 'LineWidth', 4, 'Color', 'k', 'DisplayName', 'Example Psychometric');
% Set figure properties
title('');
legend('Location', 'NorthWest');
xlabel('Coherence ((-)Leftward, (+)Rightward)');
